    ...
    class Notifier {
        constructor(options) {
            ...
            if (Notifier.instances[this.container_id]) {
                var existing_instance = Notifier.instances[this.container_id];
            ...
            this.container.className =
                'notifier-container notifier-' + this.position + ' notifier-' + this.alignment;
        ...
        notify(message, type, timeout) {
            ...
            if (this.notifications.length > this.max_notifications) {
                var oldest_notification = this.notifications.shift();
